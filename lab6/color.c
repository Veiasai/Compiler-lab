...
static int locate_register(Temp_temp temp) {
	...
	else if (temp == F_R8()) return 8;
	else if (temp == F_R9()) return 9;
	else if (temp == F_R10()) return 10;
	else if (temp == F_R11()) return 11;
	else if (temp == F_R12()) return 12;
	else if (temp == F_R13()) return 13;
